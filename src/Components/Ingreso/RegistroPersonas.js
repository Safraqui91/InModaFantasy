...
export default function RegistroPersonas({ setVistaRegistro }) {
    const initialState = {
        names: {
            error: false,
            msg: '',
    ...
    const Registrar = () => {
        ...
        formData.append('lastName', dataForm.lastName.val)
        ...
        formData.append('TipoFormulario', 1)
    ...
    const ValidarStep = (step) => {
        ...
        switch (step) {
            case 1:
                ...
                if (isEmpty(data.lastName.val)) {
                    data = {
                        ...data,
                        lastName: {
                            ...data.lastName,
                            error: true,
                            msg: '*Ingresar apellidos completos'
                        }
                    }
                    isValid = false;
                }
    ...
    return (
        <Col xs={12}>
            <Row className="row-column-flex">
                ...
                <Col xs={12}>
                    <div className='title-form'>Registro Persona Natural</div>
                    <hr />
                </Col>
                <Col xs={12}>
            ...
            {/*<Row className='padd-10'>
                <Col xs={12} xl={5} className={'labelContainer'}>
                    <span className={'label'}>Adjuntar RUT o documento de identidad:</span>
                </Col>
                <Col xs={12} xl={7}>
                    <File
                        id="custom-file-translate-html"
                        label="Adjuntar documento de identidad"
    ...
    return (
        <>
            <Row className='padd-10'>
                ...
                <Col xs={12} xl={7}>
                    <input type='text' className='inputLogin' value={dataForm.names.val} name='names' onChange={onChange} />
            ...
            <Row className='padd-10'>
                ...
                <Col xs={12} xl={7}>
                    <input type='text' className='inputLogin' value={dataForm.lastName.val} name='lastName' onChange={onChange} />
                    <label className="label-error">{dataForm.lastName.msg}</label>
                </Col>
            </Row>
            <Row className='padd-10'>
                <Col xs={12} xl={5} className={'labelContainer'}>
                ...
                <Col xs={12} xl={7}>
                    <input onKeyDown={onKeyDown} className='inputLogin' type='text' value={dataForm.phone.val} name='phone' onChange={onChange} />
    ...
    return (
        <>
            <Row className='padd-10'>
                ...
                <Col xs={12} xl={7}>
                    <Control as={'select'} name={'tipoDoc'} value={dataForm.tipoDoc.val} onChange={onChange}>
            ...
            <Row className='padd-10'>
                ...
                <Col xs={12} xl={7}>
                    <input type='text' className='inputLogin' value={dataForm.documento.val} name='documento' onChange={onChange} />
            ...
            <Row className='padd-10'>
                ...
                <Col xs={12} xl={7}>
                    <input type='email' className='inputLogin' value={dataForm.email.val} name='email' onChange={onChange} />
            ...
            <Row className='padd-10'>
                ...
                <Col xs={12} xl={7}>
                    <input type='password' className='inputLogin' value={dataForm.pass.val} name='pass' onChange={onChange} />
                ...
                <Col xs={12} xl={7}>
                    <Row >
                        <Col xs={12} className='padd-cero'>
                            <input onKeyDown={onKeyDown} type='password' className='inputLogin' value={dataForm.passConfirm.val} name='passConfirm' onChange={onChange} />
            ...
            <Row className='contain-center' style={{flexDirection:'row'}}>
                <Col xs={6}>
        ...
        <>
            <Row className='padd-10'>
                <Col xs={12} xl={5} className={'labelContainer'}>
                    ...
                    <Control as={'select'} name={'departament'} onChange={(e) => { ConsultarCiudades(e.target.value) }}>
                        {
                ...
                <Col xs={12} xl={7}>
                    ...
                    <Control as={'select'} name={'city'} onChange={(e) => {
                        setDataForm({
                            ...dataForm,
                            city: {
                                val: e.target.value,
            ...
            <Row className='padd-10' >
                ...
                <Col xs={12} xl={7}>
                    <input type='text' className='inputLogin' value={dataForm.address.val} name='address' onChange={onChange} />
